...
//                    }
        ...
        fun timingStringToList(timingDetail: String): List<RestaurantTiming> {

            val restaurantTimingList: ArrayList<RestaurantTiming> = ArrayList()

            for (timeOption in getTimingList(timingDetail)){

                    // timeOption = Mon - Tue 11:00 am-12:00 am
                    val times = timeOption.split(" ".toRegex(), 2).toTypedArray()[1]
                    //times = 11:00 am - 12:00 am
                ...
                restaurantTimingList.add(RestaurantTiming(timeWeekRange, times))

            }
            return restaurantTimingList
        }
